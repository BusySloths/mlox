...
def describe_secret_managers(workspace) -> OperationResult:
    ...
    managers = [_manager_metadata(item) for item in descriptors]
    return OperationResult(
        True,
        0,
...
def list_secret_names(workspace, manager_id: str) -> OperationResult:
    ...
    try:
        ...
        return OperationResult(
            ...
            {"manager": _manager_metadata(descriptor)},
        )
...
def reveal_secret(workspace, manager_id: str, name: str) -> OperationResult:
    ...
    try:
        ...
        return OperationResult(
            ...
            {"manager": _manager_metadata(descriptor), "name": secret_name},
        )
...
def _manager_metadata(descriptor) -> dict[str, Any]:
